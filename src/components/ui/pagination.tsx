...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    {...props}
  >
    <AltArrowLeft size={16} weight="Linear" className="h-4 w-4" />
    <span>Previous</span>
  </PaginationLink>
)
...
const PaginationNext = ({
  ...
  >
    <span>Next</span>
    <AltArrowRight size={16} weight="Linear" className="h-4 w-4" />
  </PaginationLink>
)
...
const PaginationEllipsis = ({
  ...
  <span
    ...
    {...props}
  >
    <MenuDots size={16} weight="Linear" className="h-4 w-4" />
